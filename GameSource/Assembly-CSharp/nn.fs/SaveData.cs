...
{
	public static ErrorRange ResultUsableSpaceNotEnoughForSaveData => new ErrorRange(2, 31, 32);
	...
	public static Result EnsureForDebug(long saveDataSize, long saveDataJournalSize)
	{
		return default(Result);
	}
}
