...
internal abstract class ProtocolProcessorBase : IProtocolProcessor
{
	...
	protected static string[] ExptectedResponseVerbLines = new string[3] { "HTTP/1.1 101 WebSocket Protocol Handshake", "HTTP/1.1 101 Web Socket Protocol Handshake", "HTTP/1.1 101 Switching Protocols" };
