...
public static class Npad
{
	...
	public static ErrorRange ResultColorNotAvailable => new ErrorRange(202, 603, 604);

	public static ErrorRange ResultControllerNotConnected => new ErrorRange(202, 604, 605);
