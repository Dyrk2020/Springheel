...
public class CapitalizationManager : BaseManager<CapitalizationManager, CapitalizationFilter>
{
	...
	public int CapitalizationCharsNumber
	{
		get
		{
			return _filter?.CharacterNumber ?? capitalizationCharsNumber;
		}
		set
		{
			_filter.CharacterNumber = (capitalizationCharsNumber = ((value < 1) ? 1 : value));
		}
	}
	...
	{
		base.Awake();
		if (Singleton<CapitalizationManager>.Instance == this)
		{
			Load();
		}
	}
	...
	{
		Singleton<CapitalizationManager>.DeleteInstance();
	}

	public void Load()
	{
		_filter = new CapitalizationFilter(capitalizationCharsNumber, base.DisableOrdering);
	}
