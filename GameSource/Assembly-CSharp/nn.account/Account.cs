...
public static class Account
{
	...
	public static ErrorRange ResultCancelled => new ErrorRange(124, 0, 1);

	public static ErrorRange ResultCancelledByUser => new ErrorRange(124, 1, 2);

	public static ErrorRange ResultUserNotExist => new ErrorRange(124, 100, 101);
	...
	public static Result ShowLicenseRequirementsForNetworkService(UserHandle handle)
	{
		return default(Result);
	}
	...
	public static Result ShowLicenseRequirementsForNetworkService(UserHandle handle, bool suspendUnityThreads)
	{
		return ShowLicenseRequirementsForNetworkService(handle);
	}
}
