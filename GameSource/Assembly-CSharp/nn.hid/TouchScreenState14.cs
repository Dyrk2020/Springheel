...
public struct TouchScreenState14
{
	public struct TouchStateArray14 : IList<TouchState>, ICollection<TouchState>, IEnumerable<TouchState>, IEnumerable
	{
		...
		{
			return $"{{{_value0},{_value1},{_value2},{_value3},{_value4},{_value5},{_value6},{_value7},{_value8},{_value9},{_value10},{_value11},{_value12},{_value13}}}";
		}
	...
	{
		touches = default(TouchStateArray14);
	}
}
