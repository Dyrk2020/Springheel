...
public struct TouchScreenState15
{
	public struct TouchStateArray15 : IList<TouchState>, ICollection<TouchState>, IEnumerable<TouchState>, IEnumerable
	{
		...
		{
			return $"{{{_value0},{_value1},{_value2},{_value3},{_value4},{_value5},{_value6},{_value7},{_value8},{_value9},{_value10},{_value11},{_value12},{_value13},{_value14}}}";
		}
	...
	{
		touches = default(TouchStateArray15);
	}
}
