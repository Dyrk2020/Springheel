...
internal class TwitchChatServerConnection
{
	...
	public TwitchChatStream stream => _stream;
	...
	public bool isReadyToReceiveMessages => _state >= ConnectionState.Connected;

	public bool isReadyToSendMessages => _state == ConnectionState.CapabilitiesAcknowledged;
