...
internal class GSTlsAuthentication : TlsAuthentication
{
	...
	private IList validCertNames = new ArrayList();
	...
	public void NotifyServerCertificate(Certificate serverCertificate)
	{
		...
		{
			string text = GSTlsVerifyCertificate.OnVerifyCertificate(serverCertificate);
			if (text != null)
			{
				throw new TlsFatalAlert(42, new Exception(text));
			}
		}
	}
}
