...
internal sealed class OperationParam
{
	...
	public static readonly OperationParam ProductServiceOpCashInReceiptReceipt = new OperationParam("receipt");

	public static readonly OperationParam ProductServiceOpCashInReceiptUrl = new OperationParam("url");
