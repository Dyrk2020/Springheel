...
public class TwitchText : Text
{
	...
	private Dictionary<string, string> _userToColorMap = new Dictionary<string, string>();
	...
	private void RenderMessage(ref TwitchChatMessage msg)
	{
		...
		{
			string text2 = "";
			if (_userToColorMap.TryGetValue(msg.userName, out var value))
			{
				text2 = value;
			}
			else
			{
				text2 = msg.userNameColor;
				...
				_userToColorMap.Add(msg.userName, text2);
			}
