...
public static class BCGSJson
{
	private sealed class Parser : IDisposable
	{
		...
		{
			double.TryParse(NextWord, NumberStyles.Any, CultureInfo.InvariantCulture, out var result);
			return result;
		}
	...
	private sealed class Serializer
	{
		...
		{
			if (value is IBCGSData)
			{
				value = ((IBCGSData)value).BaseData;
			}
			if (value == null)
			{
				builder.Append("null");
