...
{
	public static ErrorRange ResultDualConnected => new ErrorRange(202, 601, 602);

	public static ErrorRange ResultSameJoyTypeConnected => new ErrorRange(202, 602, 603);
	...
	[DllImport("NintendoSDKPlugin", CallingConvention = CallingConvention.Cdecl, EntryPoint = "nn_hid_SetNpadJoyAssignmentModeSingle3")]
