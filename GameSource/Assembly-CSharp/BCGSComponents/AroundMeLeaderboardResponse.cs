...
public class AroundMeLeaderboardResponse : BCGSTypedResponse
{
	...
	public bool? Social => response.GetBoolean("social");

	public AroundMeLeaderboardResponse(BCGSData data)
		: base(data)
	{
	}
}
