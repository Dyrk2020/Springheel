...
public static class ReasonCodes
{
	...
	public const int CHILD_USER_MISSING = 40379;

	public const int DISABLED_APP = 40330;

	public const int APPS_NOT_IN_SAME_COMPANY = 40388;

	public const int APP_LIMIT_REACHED = 40371;

	public const int GAME_APP_MISMATCH = 40378;

	public const int APP_RUNSTATE_DISABLED = 40372;

	public const int APP_VERSION_NOT_SUPPORTED = 40322;

	public const int IMPORT_MISSING_APP_DATA = 40352;

	public const int INVALID_APP_ID = 40316;

	public const int INVALID_USER_ID = 40374;

	public const int INVALID_USER_STATISTICS_EVENT_NAME = 40321;

	public const int MISSING_APP_PARENT = 40377;

	public const int MISSING_APP_ID = 40382;

	public const int MISSING_USER_PARENT = 40380;

	public const int USER_PARENT_MISMATCH = 40381;

	public const int USER_SESSION_EXPIRED = 40303;

	public const int USER_SESSION_LOGGED_OUT = 40356;

	public const int USER_SESSION_MISMATCH = 40305;

	public const int UNABLE_TO_VALIDATE_USER = 40302;
}
